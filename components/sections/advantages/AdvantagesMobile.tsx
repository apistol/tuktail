...
() {
    return (
        <div id={"advantages"} className={"lg:hidden flex flex-col justify-center align-middle"}>

            <div className={"h-screen flex flex-col justify-center align-middle m-10 relative"}>
                <Image alt={"Avantaje Tuk"} width={500} height={500} className={"w-full"} src={"./advantages-motive.svg"}/>
